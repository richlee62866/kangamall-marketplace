...
// packages/modules/payout/src/services/provider.ts
...
export class PayoutProvider implements IPayoutProvider {
  ...
  // All payout methods throw if called
  async createPayout(
    _input: ProcessPayoutInput
  ): Promise<ProcessPayoutResponse> {
    throw new MedusaError(
      MedusaError.Types.UNEXPECTED_STATE,
      "Stripe is disabled — createPayout cannot be executed."
    );
  }
  ...
  async createPayoutAccount(
    ...
    throw new MedusaError(
      MedusaError.Types.UNEXPECTED_STATE,
      "Stripe is disabled — createPayoutAccount cannot be executed."
    );
  }
  ...
  async initializeOnboarding(
    ...
    throw new MedusaError(
      MedusaError.Types.UNEXPECTED_STATE,
      "Stripe is disabled — initializeOnboarding cannot be executed."
    );
  }
  ...
  async getAccount(_accountId: string) {
    throw new MedusaError(
      MedusaError.Types.UNEXPECTED_STATE,
      "Stripe is disabled — getAccount cannot be executed."
    );
  }

  async reversePayout(_input: ReversePayoutInput) {
    throw new MedusaError(
      MedusaError.Types.UNEXPECTED_STATE,
      "Stripe is disabled — reversePayout cannot be executed."
    );
  }

  async getWebhookActionAndData(
    _payload: PayoutWebhookActionPayload
  ): Promise<{ action: PayoutWebhookAction; data: any }> {
    throw new MedusaError(
      MedusaError.Types.UNEXPECTED_STATE,
      "Stripe is disabled — webhook cannot be executed."
    );
  }
}
